...
#define GDT_CODE_KERN GDT_ENTRY(0x00000000, 0xFFFFFFFF, 0xCF9A)
#define GDT_DATA_KERN GDT_ENTRY(0x00000000, 0xFFFFFFFF, 0xCF92)

#define GDT_CODE_USER GDT_ENTRY(0x80000000, 0xFFFFFFFF, 0xCFFA)
#define GDT_DATA_USER GDT_ENTRY(0x80000000, 0xFFFFFFFF, 0xCFF2)
//#define GDT_CODE_USER GDT_ENTRY(0x00000000, 0xFFFFFFFF, 0xCFFA)
//#define GDT_DATA_USER GDT_ENTRY(0x00000000, 0xFFFFFFFF, 0xCFF2)
